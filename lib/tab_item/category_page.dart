...
import 'package:second_api_project/screen/edit_category.dart';
    ...
    return Scaffold(
                                                            ...
                                                            actions: <Widget>[
                                                              ...
                                                              TextButton(
                                                                ...
                                                                onPressed: () async {
                                                                  ...
                                                                  await CustomHttpRequest.deleteCategory(categoryList[index].id!.toInt());
      ...
      floatingActionButton: _bottomVisible == true
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const AddCategory())).then((value) => category.getCatagoryData());
             },
